...
const cclass_data cclasses[CREW_CLASSES]={
	[CCLASS_P] = {.letter='P', .name="Pilot",       .desc="The pilot flies the bomber and is responsible for the lives of the whole crew.", .initpool=60, .pupils=2, .extra_pupil=CCLASS_E},
	...
	[CCLASS_E] = {.letter='E', .name="Engineer",    .desc="The flight-engineer keeps the 'plane in good working order.",                    .initpool=50, .pupils=4, .extra_pupil=CCLASS_NONE},
	[CCLASS_W] = {.letter='W', .name="Wireless-op", .desc="The W/Op handles signals to and from base.",                                     .initpool=30, .pupils=6, .extra_pupil=CCLASS_G},
	[CCLASS_G] = {.letter='G', .name="Gunner",      .desc="The air-gunner watches for enemy fighters, and tries to shoot them down.",       .initpool=75, .pupils=5, .extra_pupil=CCLASS_NONE},
};
