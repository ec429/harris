...
extern SDL_Surface *terrain, *location, *yellowhair, *nointelbtn, *intelbtn, *navpic[NNAVAIDS], *elitepic, *studentpic, *resizebtn, *fullbtn, *exitbtn, *markpic[4], *grouppic[7], *england;
