...
extern SDL_Surface *terrain, *location, *yellowhair, *nointelbtn, *intelbtn, *navpic[NNAVAIDS], *winpic[NWINLVLS], *elitepic, *studentpic, *resizebtn, *fullbtn, *exitbtn, *markpic[MAX_MARKS], *grouppic[8], *england;
