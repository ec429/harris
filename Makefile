...
CC ?= gcc
CFLAGS += -Wall -Wextra -Werror --std=gnu11 -g -DDATIDIR=\"$(DATIDIR)\" -DUSAVDIR=\"$(USAVDIR)\" -Wno-format-truncation -Wno-missing-field-initializers
...
BUILDER_OBJS := builder/data.o builder/calc.o builder/init.o builder/save.o builder/parse.o builder/art.o
...
SAVES := save/qstart.sav save/civ.sav save/abd.sav save/ruhr.sav save/builder.sav
...
post_raid.o: ui.h globals.h bits.h date.h history.h mods.h rand.h control.h handle_squadrons.h research.h builder/data.h builder/list.h builder/calc.h handle_manfs.h
...
handle_manfs.o: ui.h globals.h date.h bits.h builder/data.h builder/list.h builder/calc.h builder.h control.h post_raid.h rand.h
