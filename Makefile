...
LIBS := -latg -lm
OBJS := weather.o bits.o rand.o geom.o widgets.o date.o history.o routing.o saving.o render.o events.o main_menu.o load_game.o save_game.o control.o run_raid.o
